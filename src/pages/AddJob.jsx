  ...
  return (
    <div className="min-h-screen bg-[#121318] text-[#f3f4f6] p-5 md:p-8 font-sans antialiased">
      ...
      <div className="max-w-xl mx-auto flex justify-between items-center border-b border-slate-800 pb-6 mb-8">
        <div>
          <h2 className="text-xl font-bold text-white tracking-tight">New Application</h2>
          <p className="text-xs text-slate-400 mt-1">Log a new job opportunity into your tracker.</p>
        </div>
        <Link to="/dashboard" className="text-xs font-bold text-slate-400 hover:text-emerald-400 transition-colors">
          Cancel
        </Link>
      </div>
        ...
        <form action={formAction} className="space-y-5 text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select 
                name="status" 
                required 
                className="w-full px-4 py-3 bg-[#121318] border border-slate-800 rounded-xl text-slate-100 focus:outline-none focus:border-emerald-400 transition-colors cursor-pointer"
              >
            ...
            <div>
              ...
              <input 
                ...
                name="applied_date" 
                required 
                className="w-full px-4 py-3 bg-[#121318] border border-slate-800 rounded-xl text-slate-100 focus:outline-none focus:border-emerald-400 transition-colors" 
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea 
              name="notes" 
              rows="4" 
              className="w-full px-4 py-3 bg-[#121318] border border-slate-800 rounded-xl text-slate-100 placeholder-slate-600 focus:outline-none focus:border-emerald-400 transition-colors resize-none" 
          ...
          <button 
            type="submit" 
            disabled={isPending} 
            className="w-full py-3 px-4 bg-emerald-400 hover:bg-emerald-300 disabled:bg-emerald-800 text-slate-950 font-bold rounded-xl transition-colors duration-200 active:scale-[0.99]"
          >
